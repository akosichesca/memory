...
python train.py --memory_size=20000 --batch_size=16 --validation_length=50  --episode_width=5 --episode_length=50 --num_episodes=100 --save_dir=prec32 --precision_bits=32